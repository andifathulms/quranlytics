# Generated by Django 5.0.6 on 2026-06-24 14:52
...
class Migration(migrations.Migration):
    ...
    operations = [
        # Required by the gin_trgm_ops index on Word.arabic (fuzzy search).
        TrigramExtension(),
        ...
        migrations.AddIndex(
            model_name='verse',
            index=models.Index(fields=['revelation_order'], name='quran_verse_revelat_15e592_idx'),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['language'], name='quran_trans_languag_5651c3_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='translation',
        ...
        migrations.AddIndex(
            ...
            index=django.contrib.postgres.indexes.GinIndex(fields=['surah_distribution'], name='wordfreq_dist_gin'),
        ),
        migrations.AddIndex(
            model_name='wordfrequency',
            index=models.Index(fields=['total_count'], name='quran_wordf_total_c_3d9f04_idx'),
        ),
        ...
        migrations.AddIndex(
            model_name='word',
            index=models.Index(fields=['lemma'], name='quran_word_lemma_d8cbd2_idx'),
        ),
        migrations.AddIndex(
            model_name='word',
            index=models.Index(fields=['arabic'], name='quran_word_arabic_10816d_idx'),
        ),
        migrations.AddIndex(
            model_name='word',
            index=django.contrib.postgres.indexes.GinIndex(fields=['arabic'], name='word_arabic_trgm_idx', opclasses=['gin_trgm_ops']),
        ),
        migrations.AlterUniqueTogether(
            name='word',
